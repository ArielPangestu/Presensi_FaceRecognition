    ...
    return n.extend(o.ext.buttons, {
        colvis: function (o, i) {
            var l = null, n = {
                ...
                closeButton: !1,
                buttons: [{extend: "columnsToggle", columns: i.columns, columnText: i.columnText}]
            };
            ...
            return n.columns(e.columns).indexes().map(function (n) {
                return {extend: "columnToggle", columns: n, columnText: e.columnText}
            }).toArray()
            ...
            return n.columns(e.columns).indexes().map(function (n) {
                return {extend: "columnVisibility", columns: n, visibility: e.visibility, columnText: e.columnText}
            }).toArray()
        }, columnVisibility: {
            columns: l, text: function (n, e, t) {
                return t._columnText(n, t)
            }, className: "buttons-columnVisibility", action: function (n, e, t, o) {
                var e = e.columns(o.columns), i = e.visible();
                ...
                var t = n.column(e.columns).index(), o = n.settings()[0].aoColumns[t].sTitle;
            ...
            className: "buttons-colvisRestore", text: function (n) {
            ...
            className: "buttons-colvisGroup", action: function (n, e, t, o) {
